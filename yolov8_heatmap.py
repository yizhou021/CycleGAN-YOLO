...
def get_params():
    params = {
        'weight': 'E:/project/yolov8_test/runs/train14-8sGAN/weights/best.pt', # 现在只需要指定权重即可,不需要指定cfg
        'device': 'cuda:0',
...
if __name__ == '__main__':
    ...
    model(r'E:/project/yolov8_test/dataset/水葫芦统计/heat', 'E:/notebook/mining/yolo/result/heat')